...
#ifndef _TAO_IDL_REALSHORTS_F51WIA_H_
#define _TAO_IDL_REALSHORTS_F51WIA_H_


#include "RealShortC.h"
...
#if !defined (_STANDARDINTERFACES_REALSHORT__SARG_TRAITS_)
#define _STANDARDINTERFACES_REALSHORT__SARG_TRAITS_

  template<>
  class  SArg_Traits< ::StandardInterfaces::RealShort>
    : public
...
namespace POA_StandardInterfaces
{
  ...
  public:
    ...
    typedef ::StandardInterfaces::RealShort _stub_type;
    typedef ::StandardInterfaces::RealShort_ptr _stub_ptr_type;
    typedef ::StandardInterfaces::RealShort_var _stub_var_type;

    RealShort (const RealShort& rhs);
    ...
    ::StandardInterfaces::RealShort *_this (void);
    ...
    virtual void pushPacket (
      const ::PortTypes::ShortSequence & data) = 0;
