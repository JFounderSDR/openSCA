...
#ifndef _TAO_IDL_REALFLOATS_YIQILD_H_
#define _TAO_IDL_REALFLOATS_YIQILD_H_


#include "RealFloatC.h"
...
#if !defined (_STANDARDINTERFACES_REALFLOAT__SARG_TRAITS_)
#define _STANDARDINTERFACES_REALFLOAT__SARG_TRAITS_

  template<>
  class  SArg_Traits< ::StandardInterfaces::RealFloat>
    : public
...
namespace POA_StandardInterfaces
{
  ...
  public:
    ...
    typedef ::StandardInterfaces::RealFloat _stub_type;
    typedef ::StandardInterfaces::RealFloat_ptr _stub_ptr_type;
    typedef ::StandardInterfaces::RealFloat_var _stub_var_type;

    RealFloat (const RealFloat& rhs);
    ...
    ::StandardInterfaces::RealFloat *_this (void);
    ...
    virtual void pushPacket (
      const ::PortTypes::FloatSequence & I) = 0;
