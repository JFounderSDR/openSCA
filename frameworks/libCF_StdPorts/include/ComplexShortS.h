...
#ifndef _TAO_IDL_COMPLEXSHORTS_BHLSM5_H_
#define _TAO_IDL_COMPLEXSHORTS_BHLSM5_H_


#include "ComplexShortC.h"
...
#if !defined (_STANDARDINTERFACES_COMPLEXSHORT__SARG_TRAITS_)
#define _STANDARDINTERFACES_COMPLEXSHORT__SARG_TRAITS_

  template<>
  class  SArg_Traits< ::StandardInterfaces::ComplexShort>
    : public
...
namespace POA_StandardInterfaces
{
  ...
  public:
    ...
    typedef ::StandardInterfaces::ComplexShort _stub_type;
    typedef ::StandardInterfaces::ComplexShort_ptr _stub_ptr_type;
    typedef ::StandardInterfaces::ComplexShort_var _stub_var_type;

    ComplexShort (const ComplexShort& rhs);
    ...
    ::StandardInterfaces::ComplexShort *_this (void);
